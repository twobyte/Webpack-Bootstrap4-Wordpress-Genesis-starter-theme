...
class Genesis_Featured_Post extends WP_Widget {
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title', 'genesis' ); ?>:</label>
		...
		<div class="genesis-widget-column">
			...
			<div class="genesis-widget-column-box genesis-widget-column-box-top">
				...
				<p>
					<label for="<?php echo $this->get_field_id( 'posts_cat' ); ?>"><?php esc_html_e( 'Category', 'genesis' ); ?>:</label>
					<?php
